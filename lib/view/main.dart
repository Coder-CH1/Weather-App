        ...
        child: BlocBuilder<WeatherBloc, Welcome?>(
            ...
            return  Column(
              ...
              children: [
                ...
                Text('Temperature tomorrow:${weatherData.daily.data[1].temperature2M}°C',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 20,
                ),
                ...
                Text('Wind speed: ${weatherData.daily.data[1].windSpeed10M}m/s',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 20,
                  ),
                ...
                Text('Humidity: ${weatherData.daily.data[1].relativeHumidity2M}%',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 20,
                  ),
